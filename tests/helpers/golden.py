...
#: Origin, pinned commit and licence for every vendored corpus file, grouped by
#: upstream. Metadata about the corpus, so never scanned as input itself.
CORPUS_MANIFEST = CORPUS_ROOT / "PROVENANCE.json"
